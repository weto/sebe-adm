...
<div class="<?php echo $pluralVar;?> view">
	<div class="titulo">Listagem de <?php echo "<?php echo __('{$singularHumanName}');?>";?></div>
    <br />
	<br />
	<dl>
<?php
...
<?php
	...
	echo "\t\t<li><?php echo \$this->Form->postLink(__('Excluir " . $singularHumanName . "'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, __('Tem certeza de que deseja excluir # %s?', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Listagem " . $pluralHumanName . "'), array('action' => 'index')); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Adicionar " . $singularHumanName . "'), array('action' => 'add')); ?> </li>\n";
?>
	</ul>
</div>
<?php
if (!empty($associations['hasOne'])) :
	...
	<div class="related">
		<div class="titulo"><?php echo "<?php echo __('Related " . Inflector::humanize($details['controller']) . "');?>";?></div>
		<br />
		<br />	
...
foreach ($relations as $alias => $details):
	...
	?>
<div class="related">
	<div class="titulo"><?php echo "<?php echo __('" . $otherPluralHumanName . ". Relacionadas');?>";?></div>
    <br />
	<br />
...
<?php echo "<?php endif; ?>\n\n";?>
	<div class="actions">
		<ul>
			<li><?php echo "<?php echo \$this->Html->link(__('Adicionar " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add'));?>";?> </li>
		</ul>
	</div>
</div>
<?php endforeach;?>
